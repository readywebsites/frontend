  ...
  return (
    <section id="chapter-2" className="chapter" data-chapter="2">
      <div className="about-mask-container">
        ...
        <Image
          className="about-bg"
          src="/about-us/about-us-back-01.webp"
        ...
        <div className="about-mask-layer">
          ...
          >
            <defs>
              <mask id="mask-about-avadh" maskUnits="userSpaceOnUse">
        ...
        <div className="about-content-reveal">
          <div className="content-wrapper centered">
            ...
            >
              ...
              India lives. From Surat to Ahmedabad, we craft living experiences
              that embody sophistication, innovation, and timeless elegance.
            </p>
            ...
            <div className="about-values-grid">
              <div className="value-item">
                ...
                <p>
                  ...
                  society by delivering world-class amenities with affordability
                  and accessibility.
                </p>
              </div>
